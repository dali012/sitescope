/*
  ...
  - Added the required column `userId` to the `BrainItem` table without a default value. This is not possible if the table is not empty.
...
*/
-- AlterTable
ALTER TABLE "BrainItem" ADD COLUMN     "userId" TEXT NOT NULL;

-- AlterTable
ALTER TABLE "Integration" ADD COLUMN     "userId" TEXT NOT NULL;
...
-- AddForeignKey
ALTER TABLE "BrainItem" ADD CONSTRAINT "BrainItem_userId_fkey" FOREIGN KEY ("userId") REFERENCES "user"("id") ON DELETE CASCADE ON UPDATE CASCADE;
